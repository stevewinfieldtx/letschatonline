...
app.get('/api/models', (req, res) => {
  const models = [
    ...
    { id: 'gryphe/mythalion-13b', name: 'Mythalion 13B', cost: '$', roleplayRating: '9.2/10', description: 'Built specifically for roleplay and creative writing' },
    ...
    { id: 'anthropic/claude-3-haiku', name: 'Claude 3 Haiku', cost: '$', roleplayRating: '7.5/10', description: 'Quick responses with good personality' },
    { id: 'openai/gpt-3.5-turbo', name: 'GPT-3.5 Turbo', cost: '$', roleplayRating: '7.2/10', description: 'Reliable and cost-effective for basic roleplay' },
    { id: 'meta-llama/llama-3.1-8b-instruct', name: 'Llama 3.1 8B', cost: '$', roleplayRating: '7.0/10', description: 'Good personality simulation, very affordable' },
    ...
    { id: 'cognitivecomputations/dolphin-mixtral-8x7b', name: 'Dolphin Mixtral 8x7B', cost: '$', roleplayRating: '7.8/10', description: 'Creative and expressive for roleplay scenarios' },
    { id: 'nousresearch/nous-hermes-2-mixtral-8x7b-dpo', name: 'Nous Hermes 2 Mixtral', cost: '$', roleplayRating: '7.6/10', description: 'Excellent instruction following with personality' },
    { id: 'meta-llama/llama-3.1-405b-instruct', name: 'Llama 3.1 405B', cost: '$$$', roleplayRating: '9.0/10', description: 'Massive open-source model with exceptional capabilities' },
    { id: 'openai/o1-preview', name: 'OpenAI o1-preview', cost: '$$$', roleplayRating: '8.8/10', description: 'Advanced reasoning model with deep character understanding' }
  ];
  res.json(models);
});
